...
namespace ThreadSafeHelperGenerator
{
    ...
    public class CombinedSourceGenerator : ISourceGenerator
    {
        ...
        private static string GenerateMethodWrapper(string @namespace, string className, IMethodSymbol methodSymbol)
        {
...
");
        ...
        private static string HandleThreadSafeAttribute(string methodName, string returnType, string parameters, string arguments, ImmutableArray<AttributeData> attributes)
        {
...
");
        ...
        private static string HandleSingleExecutionAttribute(string methodName, string returnType, string parameters, string arguments, ImmutableArray<AttributeData> attributes)
        {
...
");
        ...
        private static string HandleDebounceAttribute(string methodName, string returnType, string parameters, string arguments, ImmutableArray<AttributeData> attributes)
        {
...
");
        ...
        private static string HandleReadWriteLockAttribute(string methodName, string returnType, string parameters, string arguments, ImmutableArray<AttributeData> attributes)
        {
...
");
        ...
        private static string HandleTimedExecutionAttribute(string methodName, ImmutableArray<AttributeData> attributes)
        {
...
");
        ...
        private static string HandleCacheAttribute(string methodName, string returnType, string parameters, string arguments, ImmutableArray<AttributeData> attributes)
        {
...
");
        ...
        private static string HandleRetryFallbackAttributes(string methodName, string returnType, string parameters, string arguments, ImmutableArray<AttributeData> attributes)
        {
            ...
            {
                sb.Append(GenerateRetryFallbackMethod(methodName, returnType, parameters, arguments, retryAttribute, fallbackAttribute));
            }
            else if (retryAttribute != null)
            {
                sb.Append(GenerateRetryMethod(methodName, returnType, parameters, arguments, retryAttribute));
            }
            else
            {
                // No need for else if here because we already ensured the condition with previous checks
                sb.Append(GenerateFallbackMethod(methodName, returnType, parameters, arguments, fallbackAttribute));
            }

            return sb.ToString();
        }

        private static string GenerateRetryFallbackMethod(string methodName, string returnType, string parameters, string arguments, AttributeData retryAttribute, AttributeData fallbackAttribute)
        {
            ...
            bool isVoid = string.Compare(returnType, "void", true) == 0;
...
";
        ...
        private static string GenerateRetryMethod(string methodName, string returnType, string parameters, string arguments, AttributeData retryAttribute)
        {
            var maxRetries = retryAttribute.ConstructorArguments[0].Value;
            var retryInterval = retryAttribute.ConstructorArguments[1].Value;
...
";
        ...
        private static string GenerateFallbackMethod(string methodName, string returnType, string parameters, string arguments, AttributeData fallbackAttribute)
        {
            var fallbackMethodName = (string)fallbackAttribute.ConstructorArguments[0].Value;
